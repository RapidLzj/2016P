...
$operator = str_replace("'", "&#39;", $rownight["Operator"]);
$weatherg = str_replace("'", "&#39;", $rownight["WeatherGeneral"]);
$weatherl = intval($weatherg / 100);
$weatherw = intval($weatherg / 10) % 10;
$weatherh = $weatherg % 10;
$weatherd = $rownight["WeatherDesc"];
$plan = str_replace("'", "&#39;", $rownight["Plan"]);
$result = str_replace("'", "&#39;", $rownight["Result"]);
$note = str_replace("'", "&#39;", $rownight["Note"]);
$status = $rownight["Status"];
